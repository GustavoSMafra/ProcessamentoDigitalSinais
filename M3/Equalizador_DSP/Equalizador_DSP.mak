...
#
# Begin "Equalizador_DSP_Debug" configuration
#

ifeq ($(MAKECMDGOALS),Equalizador_DSP_Debug)

Equalizador_DSP_Debug : ./Debug/Equalizador_DSP.dxe 

Debug/Equalizador_DSP.doj :Equalizador_DSP.c $(VDSP)/Blackfin/include/stdio.h $(VDSP)/Blackfin/include/yvals.h $(VDSP)/Blackfin/include/string.h $(VDSP)/Blackfin/include/cycles.h $(VDSP)/Blackfin/include/xcycle_count.h $(VDSP)/Blackfin/include/limits.h $(VDSP)/Blackfin/include/cycle_count_bf.h Coef_PB.dat Coef_PA.dat Coef_BP.dat 
...
ifeq ($(MAKECMDGOALS),Equalizador_DSP_Debug_clean)
